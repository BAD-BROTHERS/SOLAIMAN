...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 MD SOLAIMAN🔥].  ║

\x1b[0;33m║       #TOOL AUTHOR [MD SOLAIMAN] ║
...
\x1b[0;33m║#FACEBOOK : NAME [Hashan Robiul ]║

\x1b[0;33m║#GROUP- Termux Command 2022.   ║
...
def menu():
	...
	print("\n\033[1;93m[\033[1;94m01\033[1;97m] CRACK ID FROM PUBLIC FRIENDS (SOLAIMAN PRO)")

	print("\033[1;93m[\033[1;94m02\033[1;97m] CRACK ID FROM PUBLIC FOLLOWERS(SOLAIMAN PRO)")
	...
	elif Bilal == "1" or SOLAIMAN == "01":

		publik()

		method()

	elif Bilal == "2" or SOLAIMAN == "02":

		follower()

		method()

	elif Bilal == "3" or  SOLAIMAN == "03":

		massal()

		method()

	elif AWAIS == "4" or SOLAIMAN == "04":
...
def publik():
	...
	idt = raw_input("\n\033[1;96m[\033[1;94m+\033[1;96m] Target Id(SOLAIMAN): ")
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mSOLAIMAN PRO/FASTER \033[1;97m]")
